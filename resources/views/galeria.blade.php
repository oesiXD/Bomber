      ...
      <img class="d-block w-100" src="{{Voyager::image($galeria->fotoportada)}}" alt="First slide">
        ...
        <h1>{{$galeria->titulo}}</h1>
          ...
          <li class="breadcrumb-item"><a href="{{ url('/inicio') }}" title="" itemprop="url">Inicio</a></li>
					<li class="breadcrumb-item"><a href="{{ url('/galerias') }}" title="" itemprop="url">Galerías</a></li>
...
<article class="">
	...
	<div class="contenedor-galeria">
		 ...
		 @if (($strf)!=NULL)
				...
				@else
				<p>No se han agregado Fotos aun a esta Galería</p>
			@endif
...
<div class="col-md-3">
	<aside class="">
        <h4>Galerías de Interés</h4>
        @foreach($galeris as $galeria)
		<div class="notice-aside">
			...
			<div class="container-read-more">
				...
				<a class="post-link" href="/Foto/{{$galeria->id}}">Ver Galería</a>
			</div>
        </div>
        @endforeach
	</aside>
