		...
		<div class="container-fluid">
			...
			<div class="collapse navbar-collapse" id="navbarResponsive">
				<ul class="navbar-nav ml-auto">
					...
					<li class="nav-item">
						<a class="nav-link" href="{{ url('/contatco') }}">Contacto</a>
					</li>
				</ul>
			</div>
		</div>
...
<section class="all-content" style="background-color: beige;">
  <div class="row" style="padding: 1%;">
  	<section class="posts col-md-9">
        ...
        <a href="noticia.blade.php" style="    background: beige;" class="thumb float-left">
...
?>
        ...
        <p class="post-contenido text-justify">{!!  str_limit( $new_str, $limit = 550, $end = '...')  !!}</p>
...
<nav aria-label="Page navigation example">
	@if($noti ->total() != 0)
	                                    <div class="Zebra_Pagination">Pagina numero
	                                        {{ ($noti ->currentpage()-1) * $noti ->perpage()+1}} vistas
	                                        {{(($noti ->currentpage()-1) * $noti ->perpage())+$noti ->count()}} de
	                                        {{$noti ->total()}} Total
	                                    </div>
