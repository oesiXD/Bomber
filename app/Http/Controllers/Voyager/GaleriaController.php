...
class GaleriaController extends \TCG\Voyager\Http\Controllers\VoyagerBaseController
{
    ...
    public function update(Request $request, $id)
    {
      ...
      $galeria->save();
        ...
        $user_name = DB::table('users')->select('name')->where('id',$user_id)->first();
        $user_name1 = json_decode(json_encode($user_name),true);
        ...
        $user_apellidoP = DB::table('users')->select('apellidoP')->where('id',$user_id)->first();
        $user_apellidoP1 = json_decode(json_encode($user_apellidoP),true);

        foreach ($user_apellidoP1 as $user_apellidoP) {
          echo $user_apellidoP;
        }
        ...
        //Optener apellido materno

        $user_apellidoM = DB::table('users')->select('apellidoM')->where('id',$user_id)->first();
        $user_apellidoM1 = json_decode(json_encode($user_apellidoM),true);

        foreach ($user_apellidoM1 as $user_apellidoM) {
          echo $user_apellidoM;
        }
